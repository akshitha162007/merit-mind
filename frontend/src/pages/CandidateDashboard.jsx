    ...
    <div className="min-h-screen bg-bg-primary">
      ...
      <aside className="fixed left-0 top-0 w-60 h-screen bg-bg-primary border-r border-white/10 p-6 flex flex-col z-50">
        ...
        <button
          ...
          className="w-full px-4 py-3 rounded-lg text-text-secondary hover:text-accent-cyan transition-colors font-medium border border-white/10 hover:border-accent-cyan/50"
        >
          Logout
        </button>
      </aside>
      ...
      <main className="ml-60 pt-20 px-8 pb-8">
        <nav className="fixed top-0 right-0 left-60 bg-bg-primary/80 backdrop-blur-md border-b border-white/10 px-8 py-4 flex items-center justify-between z-40">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-accent-cyan text-xs font-semibold">Candidate</p>
            </div>
          </div>
        </nav>
        ...
        <div className="fade-in">
          <div className="flex flex-col items-center justify-center min-h-96 text-center">
            ...
            <h1 className="text-3xl font-syne font-bold text-text-primary mb-2">Candidate Dashboard</h1>
